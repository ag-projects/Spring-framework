package com.agharibi.core;

import com.agharibi.course.Course;
import com.agharibi.course.CourseRepository;
import com.agharibi.review.Review;
import com.agharibi.user.User;
import com.agharibi.user.UserRepository;
...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        course.addReview(new Review(3, "You Rock!"));
        courses.save(course);
        ...
        IntStream.range(0, 100)
                .forEach(i -> {
                    ...
                    Course c = new Course(title, "https://www.amazon.com/");
